...
The problem asks us to traverse the grid in all directions, horizontally, vertically and diagonally to find out the maximum product of four consecutive numbers. Our approach is to use a custom window function to compute the prod of consecutive numbers while using window definitions to define the different ways of traversing the grid.
